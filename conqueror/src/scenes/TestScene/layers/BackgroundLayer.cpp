...
{
    background1 = new GameObject("background1", Transform(glm::vec2(-3.0f, 2.0f), glm::vec2(2.0f, 2.0f)));
    background2 = new GameObject("background2", Transform(glm::vec2(0.0f, 2.0f), glm::vec2(2.0f, 2.0f)));
    background3 = new GameObject("background3", Transform(glm::vec2(3.0f, 2.0f), glm::vec2(2.0f, 2.0f)));
    background4 = new GameObject("background4", Transform(glm::vec2(-3.0f, -1.0f), glm::vec2(2.0f, 2.0f)));
    background5 = new GameObject("background5", Transform(glm::vec2(3.0f, -1.0f), glm::vec2(2.0f, 2.0f)));
    background6 = new GameObject("background6", Transform(glm::vec2(-3.0f, -4.0f), glm::vec2(2.0f, 2.0f)));
    background7 = new GameObject("background7", Transform(glm::vec2(0.0f, -4.0f), glm::vec2(2.0f, 2.0f)));
    ...
    background7->addComponent(new SpriteRenderer(glm::vec4(1.0f, 1.0f, 0.0f, 1.0f), DataPool::getTexture("james_webb.png")));
