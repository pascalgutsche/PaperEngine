...
{
	font = new GameObject("fontBomb", Transform(glm::vec2(0.0f, 0.0f), glm::vec2(2.0f, 1.5f), 45.0f));
	...
	circleObject2->AddComponent(new CircleRenderer(DataPool::GetTexture("error_texture_256x256.png"),glm::vec4(0.8f, 0.5f, 1.0f, 1.0f), 1.0f, 0.005f));
