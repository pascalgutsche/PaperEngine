    ...
    void SpriteRenderer::OnUpdate() {
        switch (geometry)
        {
            case Geometry::RECTANGLE:
                if (texture)
                    Renderer::DrawRectangle(glm::vec3(gameObject->transform.position, gameObject->GetLayer()->GetZIndex()), gameObject->transform.scale, gameObject->transform.rotation, texture, 1.0f, color, gameObject->GetProjectionMode(), gameObject->GetObjectID());
                else
					Renderer::DrawRectangle(glm::vec3(gameObject->transform.position, gameObject->GetLayer()->GetZIndex()), gameObject->transform.scale, gameObject->transform.rotation, color, gameObject->GetProjectionMode(), gameObject->GetObjectID());
                break;
            case Geometry::TRIANGLE:
                if (texture)
                    Renderer::DrawTriangle(glm::vec3(gameObject->transform.position, gameObject->GetLayer()->GetZIndex()), gameObject->transform.scale, gameObject->transform.rotation, texture, 1.0f, color, gameObject->GetProjectionMode(), gameObject->GetObjectID());
                else
                    Renderer::DrawTriangle(glm::vec3(gameObject->transform.position, gameObject->GetLayer()->GetZIndex()), gameObject->transform.scale, gameObject->transform.rotation, color, gameObject->GetProjectionMode(), gameObject->GetObjectID());
                break;
