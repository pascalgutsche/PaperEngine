...
bool    ImGui_ImplOpenGL3_CreateDeviceObjects()
{
    ...
    const GLchar* fragment_shader_glsl_120 =
        ...
        "void main()\n"
        "{\n"
        "    gl_FragColor = Frag_Color * texture2D(Texture2D, Frag_UV.st);\n"
        "}\n";
    ...
    const GLchar* fragment_shader_glsl_130 =
        ...
        "void main()\n"
        "{\n"
        "    Out_Color = Frag_Color * texture(Texture2D, Frag_UV.st);\n"
        "}\n";
    ...
    bd->AttribLocationTex = glGetUniformLocation(bd->ShaderHandle, "Texture2D");
