...
struct ImFontGlyph
{
    ...
    float           U0, V0, U1, V1;     // Texture2D coordinates
};
...
struct ImFontAtlas
{
    ...
    int                         TexDesiredWidth;    // Texture2D width desired by user before Build(). Must be a power-of-two. If have many glyphs your graphics API have texture size restrictions you may want to increase texture width to decrease height.
    ...
    int                         TexWidth;           // Texture2D width calculated during Build().
    int                         TexHeight;          // Texture2D height calculated during Build().
    ImVec2                      TexUvScale;         // = (1.0f/TexWidth, 1.0f/TexHeight)
    ImVec2                      TexUvWhitePixel;    // Texture2D coordinates to a white pixel
